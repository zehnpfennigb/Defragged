 ...
 */
UCLASS(config = Game)
class DEFRAGGED_API ADFGameMode : public AGameMode
{
	...
	virtual bool CanDealDamage(class ADFPlayerState* DamageInstigator, class ADFPlayerState* DamagedPlayer) const;
