...
#include "FPSTeamDeathMatch.generated.h"

/**
 * Team Death Match Settings
 */
UCLASS(config = Game)
class FPSPROJECT_API AFPSTeamDeathMatch : public AGameMode
{
	...
	virtual bool CanDealDamage(class AFPSPlayerState* Shooter, class AFPSPlayerState* DamagedPlayer) const;
...
protected:
	...
	int32 ChooseTeam(class AFPSPlayerState* PlayerState) const;
